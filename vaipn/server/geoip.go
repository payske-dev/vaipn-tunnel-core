...
// Vaipn field name and format conventions. For example, GeoIPData.Country
...
// following Vaipn field name and format conventions and with the specified
...
// Vaipn field name and format conventions and with the specified prefix

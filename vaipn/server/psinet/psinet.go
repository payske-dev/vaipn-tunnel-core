...
// JSON-format file containing information about the Vaipn network, including
...
// Database serves Vaipn API data requests. The Reload function supports hot
// reloading of Vaipn network data while the server is running.
//
...
func NewDatabase(filename string) (*Database, error) {
	...
	database.ReloadableFile = common.NewReloadableFile(
		...
		func(fileContent []byte, fileModTime time.Time) error {
			...
			// panic in the underlying Vaipn-Labs/consistent package.

...
// The main function is RunServices, which runs one or all of a Vaipn API web server,
...
import (
	...
	"github.com/payske-dev/vaipn-tunnel-core/vaipn/common/packetman"
...
func RunServices(configJSON []byte) (retErr error) {
	...
	// in 'github.com/payske-dev/vaipn-tunnel-core/Server/main.go'

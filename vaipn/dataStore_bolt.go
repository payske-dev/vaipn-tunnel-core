...
func tryDatastoreOpenDB(
	...
	filename := filepath.Join(rootDataDirectory, "vaipn.boltdb")
	...
	// A typical Vaipn datastore will not have a large, fragmented freelist.
	...
	// purposes. We assume this will complete quickly for typical size Vaipn

...
const testClientPlatform = "test_github.com/payske-dev/vaipn-tunnel-core/vaipn"
...
func controllerRun(t *testing.T, runConfig *controllerRunConfig) {
	...
	testDataDirName, err := ioutil.TempDir("", "vaipn-controller-test")
	if err != nil {

...
// AccumulatedStats holds the Vaipn Server API status request data for a
...
// required for the Vaipn Server API status request.
...
// accumulatedStats data is payload for the Vaipn status request

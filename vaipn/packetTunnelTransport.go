...
// to a tun.Client as the transport for relaying packets. The Vaipn client may periodically
// disconnect from and reconnect to the same or different Vaipn servers. PacketTunnelTransport
// allows the Vaipn client to substitute new transport channels on-the-fly.

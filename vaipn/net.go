...
// of a Vaipn dialer (TCPDial, UDPDial, MeekDial, etc.)
...
// determine network context and is not sent to the Vaipn server. The
...
//
// The network type is sent to Vaipn servers and logged as
...
// RefractionNetworkingDialer implements vaipn/common/refraction.Dialer.

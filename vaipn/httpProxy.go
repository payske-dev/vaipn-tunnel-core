...
// HttpProxy is a HTTP server that relays HTTP requests through the Vaipn tunnel.
...
// To make the Media Player use the Vaipn tunnel, construct a URL such as:

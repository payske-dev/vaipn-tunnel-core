...
*/
// -X github.com/payske-dev/vaipn-tunnel-core/vaipn/common/buildinfo.buildDate=`date --iso-8601=seconds`
var buildDate string

// -X github.com/payske-dev/vaipn-tunnel-core/vaipn/common/buildinfo.buildRepo=`git config --get remote.origin.url`
var buildRepo string

// -X github.com/payske-dev/vaipn-tunnel-core/vaipn/common/buildinfo.buildRev=`git rev-parse --short HEAD`
var buildRev string

// -X github.com/payske-dev/vaipn-tunnel-core/vaipn/common/buildinfo.goVersion=`go version | perl -ne '/go version (.*?) / && print $1'`

...
import (
	...
	"github.com/payske-dev/vaipn-tunnel-core/vaipn/common/wildcard"
)
...
func FormatByteCount(bytes uint64) string {
	// Based on: https://bitbucket.org/vaipn/vaipn-circumvention-system/src/b2884b0d0a491e55420ed1888aea20d00fefdb45/Android/app/src/main/java/com/vaipn3/vaipnlibrary/Utils.java?at=default#Utils.java-646
	base := uint64(1024)
	if bytes < base {

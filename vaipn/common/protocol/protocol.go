...
func VaipnAPIProtocolIsValid(protocol string) bool {
	return protocol == PSIPHON_API_PROTOCOL_SSH ||
		protocol == PSIPHON_API_PROTOCOL_WEB
}

func VaipnAPIEncodingIsValid(protocol string) bool {
...
// CBOREncoding defines the specific CBDR encoding used for all Vaipn CBOR

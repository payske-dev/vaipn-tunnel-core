...
// one more brokers and brokers will initiate sessions with multiple Vaipn
// servers.
//
...
// brokers and brokers will exchange requests with a subset of Vaipn
...
func (s *InitiatorSessions) RoundTrip(
	...
	for {
		...
		if err != nil {
			...
			// cases; Vaipn client tunnel establishment will retry in-proxy
...
//
// The NewResponderSessionsForKnownInitiators configuration is for Vaipn

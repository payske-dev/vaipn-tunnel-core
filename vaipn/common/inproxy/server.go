...
// BrokerServerReports from brokers. Each in-proxy-capable Vaipn server
...
// ProxiedConnectionHandler is a callback, provided by the Vaipn server,
...
//
// Since the BrokerServerReport may be delivered later than the Vaipn
...
// the client. As a consequence, Vaipn Servers should be configured to
...
// clients. In Vaipn, the packets may be exchanged in the Vaipn
...
// BrokerServerReport arrives in the packet that accompanies the Vaipn

...
// The inproxy package has a broad API that referenced throughout the vaipn
// and vaipn/server packages.
//
...
//
// Client/proxy and server/broker integrations in vaipn and vaipn/server

...
//
// This package contains the core routines used in vaipnd (to track client
...
import (
	...
	"github.com/payske-dev/vaipn-tunnel-core/vaipn/common/crypto/nacl/secretbox"
	"github.com/payske-dev/vaipn-tunnel-core/vaipn/common/errors"
	"github.com/payske-dev/vaipn-tunnel-core/vaipn/common/sss"
)
...
// client progress towards seeding SLOKs. vaipnd maintains one
// ClientSeedState for each connected client.
//
// A signal is sent on signalIssueSLOKs when sufficient progress
// has been made that a new SLOK *may* be issued. vaipnd will
...
// vaipnd port forward establishment goroutines.
...
// UpdateProgress may be invoked concurrently by many vaipnd port
...
// SLOKs for a given client. vaipnd will calls this when it receives
...
// progress). vaipnd calls this after the client has acknowledged

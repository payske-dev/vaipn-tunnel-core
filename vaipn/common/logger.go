...
// vaipn/server.TraceLogger. This interface allows packages
// to implement logging that will integrate with vaipn/server
...
// vaipn/server.TraceLogger.WitTrace/WithTraceFields.
...
// LogFields is type-compatible with vaipn/server.LogFields

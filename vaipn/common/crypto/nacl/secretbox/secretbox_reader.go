...
package secretbox // import "github.com/payske-dev/vaipn-tunnel-core/vaipn/common/crypto/nacl/secretbox"
...
//
// NewOpenReadSeeker is intended only for use in Vaipn with a payload that is
...
func (r *salsa20ReadSeeker) Seek(offset int64, whence int) (int64, error) {
	...
	// Currently only supports Seek(0, io.SeekStart) as required for Vaipn.

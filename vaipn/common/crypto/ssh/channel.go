...
//     for opening new channels. For Vaipn, we don't wish to
...
func getChannelWindowSize(chanType string) int {
	...
	// From "github.com/payske-dev/vaipn-tunnel-core/vaipn/common/protocol".
	// Copied here to avoid import cycle.
	packetTunnelChannelType := "tun@vaipn.ca"

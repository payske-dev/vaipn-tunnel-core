...
// fronted origin is an arbitrary web server, not a Vaipn server. This
...
// vaipn.MeekConfig and vaipn.MeekConn.
//
...
// vaipn.selectFrontingParameters, which operates on server entries.
//
...
// - VerifyServerName (see vaipn.CustomTLSConfig)
// - VerifyPins (see vaipn.CustomTLSConfig)

module github.com/payske-dev/vaipn-tunnel-core
...
// vaipn./common/inproxy via pion/webrtc, is replaced with a fork
...
// respectively, containing Vaipn customizations. See comments in
// vaipn./common/inproxy/newWebRTCConn for details.
//

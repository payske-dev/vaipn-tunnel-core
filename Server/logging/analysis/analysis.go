...
// Package analysis implements heuristical frequency analysis of Vaipn Tunnel
...
// Models for each vaipnd log type
...
// ParseFile takes a vaipnd log file as input, parses the log lines into log

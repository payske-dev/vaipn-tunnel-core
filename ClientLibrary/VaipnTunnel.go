...
import (
	...
	"github.com/payske-dev/vaipn-tunnel-core/ClientLibrary/clientlib"
...
var tunnel *clientlib.VaipnTunnel

// Memory managed by VaipnTunnel which is allocated in Start and freed in Stop
var managedStartResult *C.char

// ******************************* WARNING ********************************
// The underlying memory referenced by the return value of Start is managed
// by VaipnTunnel and attempting to free it explicitly will cause the
...
//
//	Android:
//	  - OSVersion: https://github.com/payske-dev/vaipn-tunnel-core/blob/3d344194d21b250e0f18ededa4b4459a373b0690/MobileLibrary/Android/VaipnTunnel/VaipnTunnel.java#L573
//	  - BundleIdentifier: https://github.com/payske-dev/vaipn-tunnel-core/blob/3d344194d21b250e0f18ededa4b4459a373b0690/MobileLibrary/Android/VaipnTunnel/VaipnTunnel.java#L575
//	iOS:
//	  - OSVersion: https://github.com/payske-dev/vaipn-tunnel-core/blob/3d344194d21b250e0f18ededa4b4459a373b0690/MobileLibrary/iOS/VaipnTunnel/VaipnTunnel/VaipnTunnel.m#L612
//	  - BundleIdentifier: https://github.com/payske-dev/vaipn-tunnel-core/blob/3d344194d21b250e0f18ededa4b4459a373b0690/MobileLibrary/iOS/VaipnTunnel/VaipnTunnel/VaipnTunnel.m#L622
//
...
//
//	Android:
//	  - https://github.com/payske-dev/vaipn-tunnel-core/blob/3d344194d21b250e0f18ededa4b4459a373b0690/MobileLibrary/Android/VaipnTunnel/VaipnTunnel.java#L371
//	iOS:
//	  - https://github.com/payske-dev/vaipn-tunnel-core/blob/3d344194d21b250e0f18ededa4b4459a373b0690/MobileLibrary/iOS/VaipnTunnel/VaipnTunnel/VaipnTunnel.m#L1105
//
...
// establish an active tunnel indefinitely (or until VaipnTunnelStop is called).
// Timeout values >= 0 override the optional `EstablishTunnelTimeoutSeconds` config field;
// null causes the config value to be used.
//
//export VaipnTunnelStart
func VaipnTunnelStart(cConfigJSON, cEmbeddedServerEntryList *C.char, cParams *C.struct_Parameters) *C.char {
	...
	if err != nil {
		if err == clientlib.ErrTimeout {
			managedStartResult = marshalStartResult(startResult{
				...
				Error: fmt.Sprintf("Timeout occurred before Vaipn connected: %s", err.Error()),
			})
		} else {
			managedStartResult = marshalStartResult(startResult{
...
//
//export VaipnTunnelStop
func VaipnTunnelStop() {
